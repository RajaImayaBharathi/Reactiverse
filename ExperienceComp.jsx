  ...
  return (
    <React.Fragment>
      <div className="mt-20  min-h-screen-minus-100 flex flex-col "id="experience">
        ...
        {/* Second card */}
        <div className="m-10 flex flex-col lg:flex-row space-y-5">
          <div className="space-y-5 mb-3 mr-10">
            <div className="text-highlightOne" id="title">
              <div>
            ...
            <a
              ...
              className="flex text-white items-center font-bold text-3xl space-x-4 "
            >
              <img src="public/OPMLogo.png" alt="" className="w-10 h-11 rounded-sm" />
              <div>
                <p>OPM Corporation</p>
          ...
          <div className="p-10 rounded-lg bg-zinc-900 text-white space-y-4 lg:min-w-[500px] lg:max-w-[500px] experienceInfo">
            <p>
